      ...
      <div class="content-wrapper">
        <div class="container">
          ...
          <section class="content">
                ...
                <div class="box-body">
                  ...
                  <form method="post" action="customer_add.php" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                      <div class="form-group">
                        <label for="date" class="col-sm-3 control-label">Picture</label>
                        <div class="input-group col-md-8">
            ...
            <div class="col-md-6">
                      <div class="form-group">
                        <label for="date" class="col-sm-3 control-label">Requirement</label>
                        <div class="input-group col-md-8">
                          <input type="file" class="form-control pull-right" id="date" name="files" required>
                        </div>  
                      </div><!-- /.form group -->
                    </div>
            ...
            <div class="col-md-4">
              <div class="box box-primary">
                ...
                <form method="post" action="account_summary.php" enctype="multipart/form-data">
