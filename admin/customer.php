...
?>
                      <tr>
						...
						<td><a href="../dist/uploads/<?php echo $row['requirement'];?>">Download</a></td>
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
			  ...
			  <form class="form-horizontal" method="post" action="customer_update.php" enctype='multipart/form-data'>
				...
				<div class="form-group">
					<label class="control-label col-lg-3" for="price">Requirement</label>
					<div class="col-lg-9">
					  <input type="hidden" class="form-control" id="price" name="files1" value="<?php echo $row['requirement'];?>"> 
					  <input type="file" class="form-control" id="price" name="file">  
					</div>
				</div>
