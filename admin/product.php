      ...
      <div class="content-wrapper">
        <div class="container">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-md-12">
                      <input type="text" class="form-control pull-right" id="date" name="prod_name" placeholder="Product Name" required>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
                  <div class="form-group">
                    <label for="date">Product Description</label>
                    <div class="input-group col-md-12">
                      <textarea class="form-control pull-right" id="date" name="desc" placeholder="Product Description" required></textarea>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
				  <div class="form-group">
		 ...
		 <div class="row">
					...
					<div class="col-md-6">
						  <div class="form-group">
							<label for="date">Reorder Point</label>
							<div class="input-group col-md-12">
							  <input type="number" class="form-control pull-right" id="date" name="reorder" placeholder="Reorder Point" required>
							</div><!-- /.input group -->
						  </div><!-- /.form group -->
					</div>
					</div>
				  ...
				  <div class="col-md-6">
					  <div class="form-group">
						<label for="date">Product Price</label>
						<div class="input-group">
						  <input type="text" class="form-control pull-right" id="date" name="prod_price" placeholder="Product Price" required>
						</div><!-- /.input group -->
					  </div><!-- /.form group -->
					</div>
					</div>
          ...
          <div class="col-md-12">
            <div class="form-group">
            <label for="date">Product Image</label>
            <div class="input-group">
              <input type="file" class="form-control pull-right" id="date" name="image" placeholder="Product Price" required>
            </div><!-- /.input group -->
            </div><!-- /.form group -->
          </div>
          </div>
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
        ...
        <div class="form-group">
		    ...
		    <div class="form-group">
                                    <label for="exampleInputEmail1" class="col-lg-3">Image</label>
                                    <div class="col-lg-9">
