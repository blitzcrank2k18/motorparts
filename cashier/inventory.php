...
<?php
    ...
    $date=date('Y-m-d');
   // echo $date;
		$query=mysqli_query($con,"select * from sales natural join sales_details natural join product where user_id='$id' and date(date_added)='$date' order by prod_name")or die(mysqli_error());
		$grand=0;
